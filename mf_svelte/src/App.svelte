  ...
  <div class="card">
    <div class="card-header">
      <div class="main-logo-section">
        <img
          src="https://raw.githubusercontent.com/sveltejs/branding/2af7bc72f1bf5152dab89bee1ee2093b1be0824d/svelte-logo.svg"
          alt="Svelte"
          class="main-logo svelte"
        />
      </div>
      <div class="logo-section">
        <img
          ...
          class="logo-image federation-logo"
        />
        <span class="handshake-emoji" role="img" aria-label="handshake">🤝</span>
        <img
          src="https://mcpui.dev/logo-lg-black.png"
          alt="MCPUI Logo"
          class="logo-image mcpui-logo-img"
        />
      </div>
    </div>
    <div class="card-body">
      <h1 class="card-title">Svelte MCP-Ui Module Federation</h1>
    ...
    <div class="card-footer">
      <div class="tech-stack">
        ...
        <span class="tech-badge">MCP-UI</span>
      </div>
    </div>
  </div>
</div>
